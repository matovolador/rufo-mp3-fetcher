...
```bash
git clone https://bossnode@bitbucket.org/bossnode/rufo-mp3-fetcher.git && cd rufo-mp3-fetcher && git fetch && git checkout master && chmod +x ./install.sh && chmod +x ./run.sh && chmod +x ./install-extras.sh && chmod +x ./update.sh
```
